...
import { useLoginUserMutation, useLazyGetGoogleAuthUrlQuery } from '../store/api/authApi';
export function Login() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const msg = (err as { data?: { message?: string } })?.data?.message ?? 'Google sign-in is unavailable. Please try again.';
